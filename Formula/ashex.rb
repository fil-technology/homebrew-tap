class Ashex < Formula
  ...
  on_arm do
    url "https://github.com/fil-technology/Ashex/releases/download/v0.2.27/ashex-0.2.27-macos-arm64.tar.gz"
    sha256 "a1fe7d189ceea9f0278364c61636ab18b311086a540445635b3916554e917640"
  end
